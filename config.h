...
static char selbordercolor[]        = "#005777";
...
static const Rule rules[] = {
	...
	*/
	...
	{ "Kakaotalk",     NULL,       NULL,       	    1 << 8,       0,           0,         0,        -1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD(TERMINAL " -e chromium --app=https://google.com") },
	/* { MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmblocks; rmdir ~/.abook") }, */
	{ MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e mailspring") },
	...
	{ MODKEY,			XK_F2,		spawn,		SHCMD("kakao") },
	...
	{ MODKEY|ShiftMask,		XK_F9,		spawn,		SHCMD("dmenumount") },
